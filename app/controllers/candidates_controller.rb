class CandidatesController < ApplicationController
  ...
  private
    ...
    def candidate_params
      params.require(:candidate).permit(:year_experience_id, :avatar, :is_incognito, :zip, :city, :state_id, :ziggeo_token, :education_level_id, :archetype_score, :experiences_attributes => [:id, :position, :company, :start_date, :end_date, :description, :is_sales, :sales_type_id], educations_attributes: [:id, :school, :education_level_id, :description], candidate_question_answers_attributes: [:question_id, :id, :answer_id] )
    end
end