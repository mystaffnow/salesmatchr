...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { degree_id: @education.degree_id, description: @education.description, end_date: @education.end_date, school: @education.school, start_date: @education.start_date }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { degree_id: @education.degree_id, description: @education.description, end_date: @education.end_date, school: @education.school, start_date: @education.start_date }
    assert_redirected_to education_path(assigns(:education))
  end
