...
RSpec.describe ApplicationHelper, type: :helper do
	...
	it '#get_archetype_description_from_score' do
		...
		expect(helper.get_archetype_description_from_score(72)).to eq('Your SalesMatchr™ assessment shows that you are an Aggressive Hunter. <br/>An
		...
		expect(helper.get_archetype_description_from_score(32)).to eq('Your SalesMatchr™ assessment shows that you are a Relaxed Hunter. <br/>A Relaxed
		...
		expect(helper.get_archetype_description_from_score(12)).to eq('Your SalesMatchr™ assessment shows that you are an Aggressive Fisherman. <br/>An
		...
		expect(helper.get_archetype_description_from_score(-9)).to eq('Your SalesMatchr™ assessment shows that you are a Balanced Fisherman. <br/>A
              Balanced Fisherman likes to spend some time planning and strategizing, and then
              efficiently carries out the work at hand.')
		expect(helper.get_archetype_description_from_score(-29)).to eq('Your SalesMatchr™ assessment shows that you are a Relaxed Fisherman. <br/>A Relaxed
		...
		expect(helper.get_archetype_description_from_score(-69)).to eq("Your SalesMatchr™ assessment shows that you are an Aggressive Farmer. <br/>An
		...
		expect(helper.get_archetype_description_from_score(-71)).to eq('Your SalesMatchr™ assessment shows that you are a Relaxed Farmer. <br/>A Relaxed
	...
	it '#get_location' do
		...
		expect(helper.get_location(CandidateProfile.first)).to eq("")
